...
const HighlightColorButton = () => {
  ...
  return ( 
    <DropdownMenu>
      ...
      <DropdownMenuContent className="p-0 z-10 bg-white shadow-sm border-neutral-200 rounded">
        <SketchPicker 
          onChange={onChange}
          color={value}
        />
...
const HeadingLevelButton = () => {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="p-1 flex flex-col gap-y-1 z-10 border-2 shadow-sm border-neutral-200 bg-white rounded">
